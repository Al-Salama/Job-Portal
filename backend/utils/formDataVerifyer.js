...
const requiredInfo = {
  ...
  files: ["cv", "certificate"],
  experience: ["employer", "title", "years", "quit"],
...
function verifyApplicationData(fields = {}, files = {}) {
  // Making sure that the user has provided all the requaired data.
  let verified;
